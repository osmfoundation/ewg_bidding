...
I am again proposing to work on reviewing [iD](https://github.com/openstreetmap/iD/) and [iD tagging schema](https://github.com/openstreetmap/id-tagging-schema/) and [schema builder](https://github.com/ideditor/schema-builder) pull requests and issues. 

Completed work will be similar in scale and type to what was done in the previous round. Reports of work done within 192 hours of previous grant can be reviewed at [the diary entry](https://www.openstreetmap.org/user/Mateusz%20Konieczny/diary/408563) and [the forum post](https://community.openstreetmap.org/t/proposed-work-on-id-triaging-improvement-of-id-tagging-schema/141303/11).

There are still issues and pull requests waiting for review, some unreasonably long. It is one of significant bottlenecks for improving this software, wastes already done work and discourages potential contributors.

I would be also working on implementing uncontroversial improvements to [iD](https://github.com/openstreetmap/iD), [iD tagging schema](https://github.com/openstreetmap/id-tagging-schema), [schema builder](https://github.com/ideditor/schema-builder) in form of own PRs.

I am already doing both triage and implementating new features as a volunteer, but would like to again to spend more time on it.

This proposed work would be a paid one if this proposal would be accepted, with cost discounted from my normal rate but less discounted than the [previous proposal](https://github.com/osmfoundation/ewg_bidding/pull/58).

I am proposing this time 300h of work, for 9000 GBP.
...
I want to note that I can imagine many projects that would be more worth doing. And I support funding them instead of this one, if people able to do them can be found at comparable wages can be found. Some would be also worth funding at higher or much higher ones. Sadly I lack skills necessary to do them, so I am proposing what I consider the most effective use of my abilities.
...
Evaluation whether project is considered as worth continuing both from perspective of myself, iD maintainer(s), EWG and consensus of OpenStreetMap community would happen afterwards - with continuation if all parties are in agreement that it is a good idea.

Deadline for completing work would be end of 2026, though I am planning to finish it earlier. I will try to finish it within 100 days from this proposal being approved.

It would be invoiced in three 100h chunks, each for 3000 GBP, with reverse charge invoices (so OSMF would pay VAT, if any - as I am unable to pay VAT in UK - with me covering other taxes known to me).

## Repetition note

Remaining parts are basically unchanged from the previous proposal, except outdated proposed wage removed, outdated info updated, history section covering new history.
...
Currently they have in total over 200 open pull requests and over 1200 open issues. See [https://github.com/openstreetmap/iD/pulls](https://github.com/openstreetmap/iD/pulls) and [https://github.com/openstreetmap/id-tagging-schema/pulls](https://github.com/openstreetmap/id-tagging-schema/pulls) and [https://github.com/ideditor/schema-builder/pulls](https://github.com/ideditor/schema-builder/pulls) and their issue listings. Though it was nice to update this from "over 200 open pull requests and over 1300 open issues".
...
Reports of work done within 192 hours of previous grant can be reviewed at [the diary entry](https://www.openstreetmap.org/user/Mateusz%20Konieczny/diary/408563) and [the forum post](https://community.openstreetmap.org/t/proposed-work-on-id-triaging-improvement-of-id-tagging-schema/141303/11).
...
See https://codeberg.org/matkoniecz/id-tagging-schema-personal-triaging/src/branch/master/ready_to_merge_prs.json5 for my triaging project. This specific file is list of not yet acted on ideas that I will raise during the next meeting with maintainers.
...
I am proposing being paid for it, I would be willing to accept rates lower than my typical wage, treating this heavily discounted pay as form of donation from me to OpenStreetMap Foundation. 
...
- maybe this funds can be spend better
    ...
    * not spending funds and keeping them in reserve may also make sense
...
I consulted with OpenStreetMap Foundation board on a public meeting where I proposed this project, got directed to Engineering Working Group. After meeting, more specific email proposal, next meeting, consulting community etc proposal was approved.

As mentioned at beginning, reports of work done within 192 hours of this grant can be reviewed at [the diary entry](https://www.openstreetmap.org/user/Mateusz%20Konieczny/diary/408563) and [the forum post](https://community.openstreetmap.org/t/proposed-work-on-id-triaging-improvement-of-id-tagging-schema/141303/11).

### This proposal

I submitted email to Engineering Working Group proposing new round. 22 days later I got info that it passed initial review and I was invited to send this public proposal as the first step of public consultations.
